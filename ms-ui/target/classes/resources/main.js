...
var routes = [
    ...
    { path: 'home', redirectTo: '/dashboard', pathMatch: 'full', canActivate: [_interceptor_AuthorizedRouteInterceptor__WEBPACK_IMPORTED_MODULE_10__["AuthorizedRouteInterceptor"]] },
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_auth_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var BasicAuthenticationInterceptor = /** @class */ (function () {
    function BasicAuthenticationInterceptor(authenticationService) {
    ...
    BasicAuthenticationInterceptor.prototype.intercept = function (req, next) {
        ...
        if (!req.url.match('/security/')) {
            var _loggedUser = this.authenticationService.getCahcedUser();
            var _credentials = _loggedUser.username + ':' + _loggedUser.password;
            req = req.clone({
                setHeaders: {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.loginService.login(_user).subscribe(function (response) {
            ...
            _this.loginService.cacheLoggedUser(response);
...
module.exports = ".recipe-container {\n    margin: 0 auto;\n}\n\n.recipe {\n    overflow-y: auto;\n    margin: 5px 5px 5px 5px;\n    box-shadow: lightgrey 1px 1px 1px;\n    float: left;\n    min-height: 415px;\n    max-height: 450px;\n}\n\n.recipe-detail-container {\n    clear: both;\n    padding: 15px;\n    background-color: #d3ff9b;\n    box-shadow: lightgrey 2px 2px 2px;\n    margin: 5px 5px 5px 5px;\n    max-height: 300px;\n    overflow-y: auto;\n}\n\n.show-details {\n    background-color: lightgrey;\n    border: none;\n    margin: 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/global/global-constants.service */ "./src/app/service/global/global-constants.service.ts");




var MyrecipeComponent = /** @class */ (function () {
    function MyrecipeComponent(recipeService, globalConstantService) {
        this.recipeService = recipeService;
        this.globalConstantService = globalConstantService;
        this.imageURL = this.globalConstantService.getImageUrl();
    }
    ...
    MyrecipeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_recipe_service__WEBPACK_IMPORTED_MODULE_2__["RecipeService"], _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_3__["GlobalConstantsService"]])
    ], MyrecipeComponent);
...
module.exports = ".recipe-container {\n    margin: 0 auto;\n}\n\n.recipe {\n    overflow-y: auto;\n    margin: 5px 5px 5px 5px;\n    box-shadow: lightgrey 1px 1px 1px;\n    float: left;\n    min-height: 415px;\n    max-height: 450px;\n}\n\n.recipe-detail-container {\n    background-color: #e9ecef;\n    box-shadow: lightgrey 2px 2px 2px;\n    overflow-y: auto;\n}\n\n.recipe-content-box {\n    padding: 15px;\n}\n\n.show-details {\n    background-color: lightgrey;\n    border: none;\n    margin: 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../service/global/global-constants.service */ "./src/app/service/global/global-constants.service.ts");
...
var RecipeDetailComponent = /** @class */ (function () {
    function RecipeDetailComponent(route, location, recipeService, globalConstants) {
        this.route = route;
        this.location = location;
        this.recipeService = recipeService;
        this.globalConstants = globalConstants;
        this.imageURL = this.globalConstants.getImageUrl();
    }
    ...
    RecipeDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], _service_recipe_service__WEBPACK_IMPORTED_MODULE_4__["RecipeService"], _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_6__["GlobalConstantsService"]])
...
module.exports = ".recipe-container {\n    margin: 0 auto;\n}\n\n.recipe {\n    overflow-y: auto;\n    margin: 5px 5px 5px 5px;\n    box-shadow: lightgrey 1px 1px 1px;\n    float: left;\n    min-height: 415px;\n    max-height: 450px;\n}\n\n.show-details {\n    background-color: lightgrey;\n    border: none;\n    margin: 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _service_recipe_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/recipe.service */ "./src/app/service/recipe.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/global/global-constants.service */ "./src/app/service/global/global-constants.service.ts");
...
var RecipeComponent = /** @class */ (function () {
    function RecipeComponent(recipeService, formBuilder, globalConstantsService) {
        this.recipeService = recipeService;
        this.formBuilder = formBuilder;
        this.globalConstantsService = globalConstantsService;
        this.imageURL = this.globalConstantsService.getImageUrl();
    ...
    RecipeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_recipe_service__WEBPACK_IMPORTED_MODULE_2__["RecipeService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _service_global_global_constants_service__WEBPACK_IMPORTED_MODULE_4__["GlobalConstantsService"]])
    ], RecipeComponent);
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (user) {
        var url = 'http://localhost:8084/recipe-security/api/v1/security/auth';
     ...
     * @return void
     */
    LoginService.prototype.removeLoggedUser = function () {
     ...
     * @param user
     */
    LoginService.prototype.cacheLoggedUser = function (user) {
     ...
     * @return User
     */
    LoginService.prototype.getCahcedUser = function () {
...
/***/ "./src/app/service/global/global-constants.service.ts":
/*!************************************************************!*\
  !*** ./src/app/service/global/global-constants.service.ts ***!
  \************************************************************/
/*! exports provided: GlobalConstantsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GlobalConstantsService", function() { return GlobalConstantsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var GlobalConstantsService = /** @class */ (function () {
    function GlobalConstantsService() {
        this.GATEWAY_URL = 'http://localhost:8084';
        this.IMG_URL = this.GATEWAY_URL + '/recipe-ui/assets/images';
    }
    GlobalConstantsService.prototype.getImageUrl = function () {
        return this.IMG_URL;
    };
    GlobalConstantsService.prototype.getGatewayUrl = function () {
        return this.GATEWAY_URL;
    };
    GlobalConstantsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
var RecipeService = /** @class */ (function () {
    function RecipeService(http) {
        this.http = http;
        this.API_URL = 'http://localhost:8084/recipe-api/api/v1/recipe';
    }
...
module.exports = __webpack_require__(/*! /home/valerio/git/RecipeApp/ms-ui/src/main/angular/ui/src/main.ts */"./src/main.ts");
